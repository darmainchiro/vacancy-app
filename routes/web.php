...
Route::get('/landingku', 'App\Http\Controllers\Vacancy\LandingController@getLanding')->name('display');
Route::get('/landing/contact', 'App\Http\Controllers\Vacancy\LandingController@contact')->name('contact');
Route::get('/landing/career', 'App\Http\Controllers\Vacancy\LandingController@career')->name('career');
Route::get('/landing/project', 'App\Http\Controllers\Vacancy\LandingController@project')->name('project');
Route::get('/landing/visi-misi', 'App\Http\Controllers\Vacancy\LandingController@visi')->name('visi-misi');
Route::get('/landing/apply/{id}', 'App\Http\Controllers\Vacancy\LandingController@apply')->name('apply');
Route::post('/landing/apply', 'App\Http\Controllers\Vacancy\LandingController@postApply')->name('add-apply');
